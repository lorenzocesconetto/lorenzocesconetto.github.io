---
title: "AI in Multiple GPUs with PyTorch (1/4)"
...
# Part 1/4: Understanding the Host and Device Paradigm
...
To work together, these ranks must exchange data. This can happen directly between GPUs, bypassing the CPU's main memory, though the CPU processes still orchestrate the communication. Ideally, the GPUs are connected with a high-speed interconnect like NVLink or InfiniBand.
...
In the next blog post, we will dive deeper into the communication capabilities of the `torch.distributed` module.
